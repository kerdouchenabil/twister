...
class NavigationPanel extends React.Component {
  ...
  refresh_messages(max = 1000000, etat = false) {
    ...
    /*
    this.messages = [{ "title": "titre du post", "avatar": "Z", "date": Date.now(), "media": "media", "image_file": "image file", "image_title": "img title", "message": "voici mon message post !" },
    { "title": "titre du post", "avatar": "Z", "date": Date.now(), "media": "media", "image_file": "image file", "image_title": "img title", "message": "voici mon message post !" },
    { "title": "titre du post", "avatar": "Z", "date": Date.now(), "media": "media", "image_file": "image file", "image_title": "img title", "message": "voici mon message post !" }]
    */
  }
